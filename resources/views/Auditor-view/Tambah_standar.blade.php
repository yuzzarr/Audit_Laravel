...
@section('audit-subtitle-page2', 'Standar / Tambah Standar')
            ...
            <div class="card-body">
                <div class="chart-area" >
                    <div class="row-contain" style="margin-left: -2vw;"> 
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="ruang_lingkup" required="required" class="form-control" id="exampleFormControlInput1" style="width: 45vw;" placeholder="Masukkan Nama Ruang Lingkup">
                                        <!--select class="form-control" id="specificSizeSelect" style="width: 100%; margin-bottom: 1.5vh;">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="file" id="formFileMultiple" multiple style="width: 100%; padding: 0; height: fit-content; ">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Nama PIC Auditee</label>
                        ...
                        <a href="#"><button type="button" class="btn btn-primary" style="border-radius: 12px; font-size: 1.2vw; width: 6vw; margin-top: 0px; padding: 5px; margin-left: 3vw;">Tambah</button></a>
                    </div>
                </div>
            </div>
        </div>
