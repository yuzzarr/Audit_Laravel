            ...
            <div class="card-body">
                <div class="chart-area">
                    <div class="row-contain" style="margin-left: 10px;"> 
                        ...
                        <a href="#"><button type="button" class="btn btn-primary" style="border-radius: 10px; font-size: 1.2vw; width: 6vw; margin-top: 0px; padding: 5px; margin-left: -1vw;">Tambah</button></a>
                    </div>
                </div>
            </div>
        </div>
