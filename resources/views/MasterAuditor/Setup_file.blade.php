...
@section('title-Mauditor', 'SMAS | Standar Ruang Lingkup')
...
@section('Maudit-subtitle-page2', 'Setup File')
@section('Maudit-table-title', 'Standar Ruang Lingkup')
<!-- Main Content -->      
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div
                ...
                <a href="/Tambah-file"><button type="button" class="btn btn-primary" style="border-radius: 10px; font-size: 1vw; width: 9vw; margin-top: 0px; padding: 5px;">Tambah Standar</button></a>
            </div>
            <!-- Card Body -->
            <div class="card-body">
