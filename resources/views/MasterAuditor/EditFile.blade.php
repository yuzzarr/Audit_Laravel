...
@section('title-Mauditor', 'SMAS | Master Auditor - Standar Ruang Lingkup')
...
@section('Maudit-subtitle-page2', 'Setup File / Edit Standar')
...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4" style="height: 380px;">
            ...
            <form action="/UpdateFile/{{ $p->id_Ruang_lingkup }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
            <div class="card-body">
