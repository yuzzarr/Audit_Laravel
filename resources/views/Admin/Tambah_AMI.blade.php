...
<body>
    ...
    <form action="/Setup_Periode" method="post">
        {{ csrf_field() }}
        
        Tanggal Periode <input type="date" name="tgl_periode" required="required"><br/>
        No SK <input type="text" name="no_sk" required="required"><br/>
        File SK <input type="text" name="file_sk" required="required"><br/>
        Ketua SPI <input type="text" name="ketua_api" required="required"><br/>
