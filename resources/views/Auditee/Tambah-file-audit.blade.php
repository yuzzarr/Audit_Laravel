...
@section('auditee-subtitle-page2', 'Proses Audit / Unggah File Audit')
@section('auditee-table-title', 'Unggah File Audit')
<!-- Main Content -->      
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" name="file_audit" type="file" id="formFileMultiple" required="required" multiple style="width: 100%; padding: 0%; margin-bottom: 3vh;">
                                        <p>{{ $p->file_audit }}</p>
                                    </div>
                                </div>
                            </div>
